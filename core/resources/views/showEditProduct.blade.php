                    ...
                    <form method="POST" action="{{ route('EditProduct') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body card-block">
                            <div class="form-group"><label for="company" class=" form-control-label">Product Name</label>
                                <input type="text" name="product" id="company" placeholder="Enter Product Name" class="form-control" required value="{{$arr->product_name}}">
                            </div>
                            ...
                            <div class="form-group"><label for="vat" class=" form-control-label">Select Product Category</label>
                                <select name="category" id="SelectLm" class="form-control-sm form-control" required>
                                    <option disabled>select one</option>
                                        <option>{{$arr->category_name}}</option>
                                </select>
                            </div>
                            <input type="hidden" class="form-control" id="exampleInputEmail1" name="id" placeholder="Add Category" required value="{{ $arr->id}}">


                            <label for="street" class=" form-control-label">Product Description</label>
                            <textarea type="text" name="description" id="street" placeholder="Enter Product Description" class="form-control" required style="width: 100%; height: 300px;" >{{$arr->description}}</textarea>

                            <div class="form-group"><label for="company" class=" form-control-label">Price</label>
                                <input type="number" name="price" id="company" placeholder="Enter Price" class="form-control" required value="{{$arr->price}}">
                            </div>
                            <div class="form-group"><label for="company" class=" form-control-label">Quantity</label>
                                <input type="number" name="quantity" id="company" placeholder="Enter Quantity" class="form-control" required value="{{$arr->quantity}}">
                            </div>

                            <label for="exampleInputFile">Image 1</label>
                            <div class="form-group">
                                <input type="file" name="photo" required value="{{$arr->image1}}">
                            </div>

                            <label for="exampleInputFile">Image 2</label>
                            <div class="form-group">
                                <input type="file" name="photo1" required value="{{$arr->image2}}">
                            </div>

                            <label for="exampleInputFile">Image 3</label>
                            <div class="form-group">
                                <input type="file" name="photo2" required value="{{$arr->image3}}">
                            </div>

                            <label for="exampleInputFile">Image 4</label>
                            <div class="form-group">
                                <input type="file" name="photo3" required value="{{$arr->image4}}">
                            </div>
