...
{{--                        <strong class="card-title pull-right">Count: {{$arr}}</strong>--}}
                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        @foreach($pro as $prod)
                            ...
                            <tr>
                                ...
                                <td>{{$prod->price}}</td>
                                <td>{{$prod->quantity}}</td>
                                <td><img src="{{ asset('/core/public/post/'. $prod->image1) }}" class="img-responsive" style="width:50px; height:50px"></td>
                                <td><img src="{{ asset('/core/public/post/'. $prod->image2) }}" class="img-responsive" style="width:50px; height:50px"></td>
                                <td><img src="{{ asset('/core/public/post/'. $prod->image3) }}" class="img-responsive" style="width:50px; height:50px"></td>
                                <td><img src="{{ asset('/core/public/post/'. $prod->image4) }}" class="img-responsive" style="width:50px; height:50px"></td>
                            </tr>
