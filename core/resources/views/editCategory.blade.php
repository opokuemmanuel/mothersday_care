                            ...
                            <div class="card-body">
                                ...
                                <form  method="POST" action="{{ route('editCategory') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group has-success">
                                        <label for="cc-name" class="control-label mb-1">Edit Category</label>
                                        <input id="cc-name" name="category_name" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter category name" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error" required value="{{$arr->category_name}}">
